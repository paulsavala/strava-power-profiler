...
class ClientTest(FunctionalTestBase):
    ...
    def test_get_activity_laps(self):
        ...
        self.assertEqual('Lap 1', laps[0].name)
    ...
    def test_activity_streams(self):
        ...
        self.assertGreater(len(list(streams.keys())), 3)
    ...
    def test_effort_streams(self):
        ...
        self.assertIn('distance', list(streams.keys()))
    ...
    def test_get_curr_athlete(self):
        ...
        self.assertEqual('Jeff', athlete.firstname)
        self.assertEqual('Remer', athlete.lastname)
        self.assertEqual(3, len(athlete.clubs))
        self.assertEqual('Team Roaring Mouse', athlete.clubs[0].name)
        self.assertEqual(1, len(athlete.shoes))
        print(athlete.shoes)
